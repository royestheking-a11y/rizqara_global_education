...
const countries = [
  ...
  { name: "Canada", flag: "🇨🇦", continent: "North America", tuitionRange: "$15,000-35,000", livingCost: "$1,000-1,500/month", ieltsRequired: true, popularSubjects: ["IT", "Project Management", "Health"], scholarshipCount: 22, description: "Friendly environment and high immigration success rate.", partTimeWork: true, prPathway: true, image: "https://images.unsplash.com/photo-1503614472-8c97d4d18d71?w=800", currency: "CAD", language: "English/French" },
  ...
  { name: "Spain", flag: "🇪🇸", continent: "Europe", tuitionRange: "€1,000-5,000", livingCost: "€600-900/month", ieltsRequired: false, popularSubjects: ["Business", "Sports Science"], scholarshipCount: 8, description: "Vibrant culture and affordable prestigious business schools.", partTimeWork: true, prPathway: false, image: "https://images.unsplash.com/photo-1543783232-f39000806495?w=800", currency: "EUR", language: "Spanish/English" }
];
